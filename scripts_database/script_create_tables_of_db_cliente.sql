...
EXEC sys.sp_addextendedproperty "MS_Description", "Campo que guarda o cep do endereço", "user", "dbo", "table", "TB_ENDERECO", "column", "DS_CEP"
EXEC sys.sp_addextendedproperty "MS_Description", "Campo que guarda a descrição do logradouro", "user", "dbo", "table", "TB_ENDERECO", "column", "DS_LOGRADOURO"
...
EXEC sys.sp_addextendedproperty "MS_Description", "Campo que guarda a descrição do CPF do Cliente", "user", "dbo", "table", "TB_CLIENTE", "column", "DS_CPF"
...
EXEC sys.sp_addextendedproperty "MS_Description", "Campo que guarda a descrição do e-mail do Cliente", "user", "dbo", "table", "TB_CLIENTE", "column", "DS_EMAIL"
EXEC sys.sp_addextendedproperty "MS_Description", "Campo que guarda a descrição da senha do Cliente", "user", "dbo", "table", "TB_CLIENTE", "column", "DS_SENHA"
